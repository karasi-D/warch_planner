...
namespace planner
{
  ...
  public:
    ...
    // void displayIntermediateState(ros::Publisher& intermediate_pub, planner::BsplineOptimizer::Ptr optimizer, double sleep_time, const int start_iteration);
    // void displayNewArrow(ros::Publisher& guide_vector_pub, planner::BsplineOptimizer::Ptr optimizer);
  };
} // namespace planner
#endif